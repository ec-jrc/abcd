...
- The `abcd` module has a new faster inner loop to speed up the data reading from CAEN digitizers.
  There is a new parameter in the configuration to set a timeout for this inner loop.
  The new parameter `data_reading_timeout` should go in the "abcd" entry in the configuration file.
