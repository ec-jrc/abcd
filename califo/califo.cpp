...
unsigned int verbosity = defaults_califo_verbosity;
...
void print_usage(const std::string &name = std::string("califo")) {
    ...
    std::cout << defaults_califo_status_address << std::endl;
    std::cout << "\t-D <address>: Data socket address, default: ";
    std::cout << defaults_califo_data_address << std::endl;
    std::cout << "\t-T <period>: Set base period in milliseconds, default: ";
    std::cout << defaults_califo_base_period << std::endl;
    std::cout << "\t-f <file_name>: Configuration file, default: ";
    std::cout << defaults_califo_config_file << std::endl;
...
int main(int argc, char *argv[])
{
    ...
    std::cout << std::endl;
    std::cout << "============================" << std::endl;
    std::cout << " Cali.Fo. software - v. 0.1 " << std::endl;
    std::cout << "============================" << std::endl;
    std::cout << std::endl;
    ...
    unsigned int base_period = defaults_califo_base_period;
    std::string config_file = defaults_califo_config_file;

    int c = 0;
    while ((c = getopt(argc, argv, "hA:S:D:T:f:t:vV")) != -1) {
        switch (c) {
            case 'h':
