...
namespace states
{
    ...
    extern const state CREATE_HV;
    extern const state RECREATE_HV;
    extern const state INITIALIZE_HV;
    extern const state CONFIGURE_HV;
    extern const state RECONFIGURE_DESTROY_HV;
