...
const state states::CONTINUE_ACQUISITION = \
    {307, "Continue acquisition", actions::continue_acquisition };
const state states::TRIGGER_RECONFIGURATION = \
    {308, "Trigger reconfiguration", actions::trigger_reconfiguration };
