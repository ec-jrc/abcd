...
void print_usage(const std::string &name = std::string("abad2")) {
...
int main(int argc, char *argv[])
{
    ...
    std::cout << std::endl;
    std::cout << "==================================================" << std::endl;
    std::cout << " A.B.A.D.2 software - v. 0.1                      " << std::endl;
    std::cout << " Acquisition and Broadcast for Analog Discovery 2 " << std::endl;
    std::cout << "==================================================" << std::endl;
    std::cout << std::endl;
