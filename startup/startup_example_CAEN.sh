...
#tmux new-window -d -P -t ABCD -n abcd './abcd/abcd -c 1 -l 0 -n 0 -V "0x210000" -B 8192 -T 50 -f abcd/v1730_NaI_Coincidence_DCFD.json'
# Example for a CAEN VME digitizer with direct optical link
#tmux new-window -d -P -t ABCD -n abcd './abcd/abcd -c 1 -l 0 -n 0 -B 8192 -T 10 -f abcd/v1730_NaI_Coincidence_DCFD.json'
# Example for a CAEN digitizer with optical link through A4818 the link number (-l) shall be the PID of the A4818
#tmux new-window -d -P -t ABCD -n abcd './abcd/abcd -c 5 -l 0 -n 0 -B 8192 -T 10 -f abcd/v1730_NaI_Coincidence_DCFD.json'
