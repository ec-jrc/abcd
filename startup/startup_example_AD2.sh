...
echo "Creating GUI windows, with the old interfaces"
...
echo "Creating WaPS window"
tmux new-window -d -c "$ABCD_FOLDER" -P -t ABCD -n waps './waps/waps -w -g -v -T 10 -S "tcp://127.0.0.1:16197" -P "tcp://*:16181" waps/configs/AD2_LYSO.json'
