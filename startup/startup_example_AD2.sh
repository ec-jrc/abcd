#! /bin/bash
#
# Example of startup script for hardware interfacing modules (from line 44)
...
# Example for a SP Devices ADQ digitizer
#echo "Creating absp window"
#tmux new-window -d -P -t ABCD -n absp "absp -v -T 10 -D 'tcp://*:16207' -f ADQ14_FWPD.json"
# Example for a RedPitaya
...
#tmux new-window -d -P -t ABCD -n abrp 'abrp -v -T 10 -D "tcp://*:16207" -f RedPitaya_CeBr.json'
# Example for a Digilent Analog Discovery 2
